          ...
          <table class="table  table-striped table-hover">
              ...
              <template v-for="card in sorted(ctype)">
                <tr @click="$emit('card-click', card)" :key="card.id" :class="[rarityclass(card.template.rarity), extra_type(card.deck_type), 'pointer']"
                  :title="card.template.name" data-html="true">
                  ...
                  <td v-if="should_diplay('Name')" :title="card.template.description" data-toggle="popover" data-placement="top" data-html="true" :data-content="markdown.makeHtml(card.template.description)">{{card.template.name}}</td>
