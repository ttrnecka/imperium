  ...
  <div>
    <nav class="navbar navbar-dark fixed-top bg-dark navbar-expand-md">
      <div class="container-fluid">
          <a class="navbar-brand" href="#" @click="selectCoach();menu='Coaches'">
              <img src="/static/images/Imperium.jpg" class="d-inline-block align-top"
                    width="24" alt="">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item" v-bind:class="{ active: menu=='Leaderboard' }">
                      <a class="nav-link" href="#" @click="menu='Leaderboard'">Leaderboard</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" target="_blank" href="https://bit.ly/2P9Y07F">Rules</a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="col-lg-auto" >
              ...
              <div class="list-group" id="coach-list" role="tablist">
                  <a data-toggle="list" v-for="coach in filteredCoaches"
                    ...
                    aria-controls="home">{{ coach.short_name }}</a>
              </div>
          </div>
          <div class="col-lg-8">
                              ...
                              <div v-if="is_webadmin" class="form-group">
                                  <select class="form-control col-11 coach_info"
                                    ...
                                    v-model="selectedCoach.bb2_name">
                                      ...
                                      <option v-for="name in bb2_names" :key="name" :value="name">{{name}}</option>
                                  </select>
                              </div>
                              <div v-else>
                                  <h5 class="coach_info">
...
export default {
  ...
  methods: {
    ...
    linkBB2Name() {
      ...
      const path = `/coaches/${id}`;
      Vue.axios.put(path, { name: this.selectedCoach.bb2_name })
        .then((res) => {
          const idx = this.coaches.findIndex((x) => x.id === parseInt(id, 10));
          Vue.set(this.coaches, idx, res.data);
          this.selectedCoach = this.coaches[idx];
