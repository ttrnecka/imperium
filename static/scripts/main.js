import tournament from './components/tournament.js?1.29';
  ...
  data () {
    return {
      ...
      mixed_teams: [
        ...
        {"idraces":34, "code":"cgs", "tier_tax":0, "name":'Chaos Gods Selection',   "races":['Chaos' , 'Nurgle']},
        {"idraces":33, "code":"cpp", "tier_tax":0,  "name":'Chaotic Player Pact',    "races":['Chaos' , 'Skaven', 'Dark Elf', 'Underworld']},
        {"idraces":36, "code":"egc", "tier_tax":0,  "name":'Elfic Grand Coalition',  "races":['High Elf' , 'Dark Elf', 'Wood Elf', 'Pro Elf']},
        ...
        {"idraces":41, "code":"uosp", "tier_tax":0, "name":'Union of Small People',  "races":['Ogre', 'Goblin','Halfling']},
      ...
      show_starter:1,
      rarity_order:1,
      skillreg: /(Diving Catch|Kick-Off Return|Safe Throw|Shadowing|Disturbing Presence|Sneaky Git|Horns|Guard|Mighty Blow|ST\+|\+ST|MA\+|\+MA|AG\+|\+AG|AV\+|\+AV|Block|Accurate|Strong Arm|Dodge|Juggernaut|Claw|Sure Feet|Break Tackle|Jump Up|Two Heads|Wrestle|Frenzy|Multiple Block|Tentacles|Pro|Strip Ball|Sure Hands|Stand Firm|Grab|Hail Mary Pass|Dirty Player|Extra Arms|Foul Appearance|Dauntless|Thick Skull|Tackle|Nerves of Steel|Catch|Pass Block|Piling On|Pass|Fend|Sprint|Grab|Kick|Pass Block|Leap|Sprint|Leader|Diving Tackle|Tentacles|Prehensile Tail|Sidestep|Dump-Off|Big Hand)( |,|\.|$)/g,
    }
  },
  methods: {
...
var app = new Vue({
    ...
    computed: {
      ...
      is_owner() {
        if(this.loggedCoach && this.selectedCoach && this.loggedCoach.id == this.selectedCoach.id) {
          return true;
        }
        return false;
      }
